...
public:
    ...
    SWmeta(const vector<pair<Type_Key, Type_Ts>> & stream, size_t time_window);
    ~SWmeta();
...
template<class Type_Key, class Type_Ts>
SWmeta<Type_Key,Type_Ts>::SWmeta(const vector<pair<Type_Key, Type_Ts>> & stream, size_t time_window)
